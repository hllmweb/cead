...
<head>
	<meta charset="UTF-8">
	<title>Projeto Pedagógico - Escola CEAD</title>
...
<body>
	<div id="geral">
		...
		<div id="pagina-titulo">
			<div class="limite">
				<h2><a href="">Projetos Pedagógico</a> <span></span></h2>
			</div>
		</div>
				...
				<div class="info-esquerda">
					<div id="slide-pagina">
						<ul>
							...
							<li><img src="img/projeto-2.jpg" alt="CEAD - Educação Infantil"></li>
							<li><img src="img/projeto-3.jpg" alt="CEAD - Educação Infantil"></li>
						</ul>
						
					</div>
					<div class="conteudo-pagina">
						<p class="recuo">As atividades são elaboradas com base na metodologia de ensino sócio interacionista em paralelo com a teoria construtivista desenvolvidas por <i>Vygotsky</i> e <i>Piaget</i>, respectivamente.</p>
						<p>A teoria proposta por <i>Vygotsky</i> diz que o desenvolvimento cognitivo se dá por meio da interação social ocorrentes nas relações do dia-a-dia, o que gera novos conhecimentos. Na teoria de Piaget o foco é bem similar a troca de experiências permite soluções de problemas coletivamente e estes se transformam em aprendizado.</p>
						<p>Além destas perspectivas, o <strong>CENTRO EDUCACIONAL AMOR DIVINO</strong> estimula a consciência ambiental e a responsabilidade social, pois acredita que estes conceitos fundamentam uma vida cidadã. Estes estímulos são feitos através de projetos, atividades e pesquisas solicitadas aos alunos.</p>
						<p><h3>Entra os projetos</h3>
							<ul class="lista-nao-ordenada">
								<li>Alimentação saudável</li>
								<li>Preservação do meio ambiente</li>
								<li>Seja solidário: Faça uma criança feliz </li>
								<li>Baile Infantil</li>
							</ul>
						</p>
					</div>
				</div>
